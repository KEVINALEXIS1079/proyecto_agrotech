...
import type { Callout, CalloutPos } from "@/modules/cultivo/lote/hooks/UseMapCallout";
...
/**
 * Componente UI para mostrar mensajes de error/info en el mapa.
 */
export default function MapCallout({ callout }: Props) {
