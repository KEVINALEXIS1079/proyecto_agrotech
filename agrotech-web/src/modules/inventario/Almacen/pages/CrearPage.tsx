...
import { createalmacen } from "../api/index";

export default function CrearPageAlmacen() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMensaje("✅ Almacen creado correctamente.");
    ...
    <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100 overflow-y-scroll h-[calc(100vh-10rem)] custom-scrollbar">
      ...
      <Card className="p-8 shadow-sm border border-gray-200">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Registrar Almacen</h2>
        </div>
