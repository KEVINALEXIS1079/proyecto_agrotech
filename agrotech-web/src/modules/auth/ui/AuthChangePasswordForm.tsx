...
export type AuthChangePasswordValues = { contrasena_usuario: string; confirmar: string };
export default function AuthChangePasswordForm({ onSubmit, loading }: { onSubmit: (v: AuthChangePasswordValues) => void; loading?: boolean }) {
  ...
  return (
    <form className="grid gap-3" onSubmit={(e)=>{ e.preventDefault(); onSubmit({ contrasena_usuario: pass, confirmar: confirm }); }}>
