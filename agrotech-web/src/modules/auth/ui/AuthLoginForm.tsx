...
export default function AuthLoginForm({
  ...
  return (
    <form className="grid gap-3" onSubmit={(e) => { e.preventDefault(); onSubmit({ correo, password, remember }); }}>
      <Input label="Correo electrónico" type="email" value={correo} onValueChange={setCorreo} placeholder="correo@dominio.com" radius="lg" isClearable required/>
      <Input label="Contraseña" type="password" value={password} onValueChange={setPassword} placeholder="•••••••" radius="lg" required/>
