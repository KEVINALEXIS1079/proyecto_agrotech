...
export type AuthRegisterValues = {
  ...
  correo_usuario: string; telefono_usuario: string; contrasena_usuario: string; confirmar: string; acepta?: boolean;
};
...
export default function AuthRegisterForm({ onSubmit, loading }: { onSubmit: (v: AuthRegisterValues) => void; loading?: boolean }) {
  const [form, setForm] = useState<AuthRegisterValues>({
    cedula_usuario:"", nombre_usuario:"", apellido_usuario:"", correo_usuario:"", telefono_usuario:"", contrasena_usuario:"", confirmar:"", acepta:false,
  });
