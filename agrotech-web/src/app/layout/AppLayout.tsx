...
function getCurrentUser() {
  try {
    ...
    return {
      name: u?.name ?? "Usuario",// falta que se extraiga tambien le nombre del usuario
      email: u?.email ?? "sin-correo@example.com",// el correo ya esta vinculado al login
      role: u?.role ?? "Invitado",// toca enviar el rol por localstorage
