...
export class UsuariosController {
  ...
  //Registro publico (sin autenticacion) simpre sera Rol Invitado
  @Post('public')
  async createPublic(@Body() dto: RegistrarUsuarioPublicDTO): Promise<string> {
    return this.usuariosService.createPublic(dto);
  }
