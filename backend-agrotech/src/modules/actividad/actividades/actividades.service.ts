...
export class ActividadesService {
  ...
  async update(id: number, updateActividadDto: UpdateActividadDto): Promise<string> {
    ...
    if (updateActividadDto.estado_actividad)
      existente.estado_actividad = updateActividadDto.estado_actividad;
    if (updateActividadDto.descripcion_actividad)
      existente.descripcion_actividad = updateActividadDto.descripcion_actividad;
    if (updateActividadDto.nombre_actividad)
      existente.nombre_actividad = updateActividadDto.nombre_actividad;
    if (updateActividadDto.tiempo_actividad !== undefined)
      existente.tiempo_actividad = updateActividadDto.tiempo_actividad;
    if (updateActividadDto.costo_mano_obra_actividad !== undefined)
      existente.costo_mano_obra_actividad = updateActividadDto.costo_mano_obra_actividad;
    if (updateActividadDto.fecha_actividad)
      existente.fecha_actividad = updateActividadDto.fecha_actividad;
    if (updateActividadDto.fecha_inicio_actividad)
      existente.fecha_inicio_actividad = updateActividadDto.fecha_inicio_actividad;
    if (updateActividadDto.fecha_fin_actividad)
      existente.fecha_fin_actividad = updateActividadDto.fecha_fin_actividad;
